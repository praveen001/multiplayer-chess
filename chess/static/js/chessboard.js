...
function expandConfig() {
  ...
  if (cfg.hasOwnProperty('pieceTheme') !== true ||
    ...
    cfg.pieceTheme = '../static/img/chess/{piece}.png';
  }
...
function dropSelectedPiece(location) {
	...
	if( location === 'offboard' && cfg.dropOffBoard === 'trash' ) {
	 ...
	 var newPosition = deepCopy(CURRENT_POSITION);
	// I dont give a fuck about spare pieces
	
	// source piece was on board and position is also on the board
...
function mouseclickSquare(e) {
	...
	// If already dragging a piece
	if( DRAGGING_A_PIECE == true ) {
		// Drop piece
		dropSelectedPiece(square);
	} else {
		...
		if( typeof cfg.onPieceSelect === 'function' && cfg.onPieceSelect(square, CURRENT_POSITION[square], deepCopy(CURRENT_POSITION), CURRENT_ORIENTATION, this) === false) {
			return;
		} 		

		// Set States
		DRAGGING_A_PIECE = true;
		DRAGGED_PIECE = CURRENT_POSITION[square];
